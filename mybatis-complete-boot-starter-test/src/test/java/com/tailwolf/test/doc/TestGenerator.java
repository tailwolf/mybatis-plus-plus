...
public class TestGenerator {
    public static void main(String[] args) throws ClassNotFoundException, SQLException, TemplateException, IOException {
        ...
        dbConfig.setUrl("jdbc:mysql://localhost:3306/mybatis-complete?useSSL=false&useUnicode=true&characterEncoding=utf-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
        ...
        //java文件的绝对根路径
        pathConfig.setRootPath("D:\\IdeaProject\\mybatis-complete\\mybatis-complete-starter-test\\src\\main\\java");
        //java文件的包路径
        pathConfig.setPackageName("com.tailwolf");
        //xml文件的绝对根路径
        pathConfig.setXmlRootPath("D:\\IdeaProject\\mybatis-complete\\mybatis-complete-starter-test\\src\\main\\resources");
        //xml文件的包路径
