 ...
 * @date 2020-11-15
 */
public class MybatisPlusPlusMapperProxy implements InvocationHandler, Serializable {
    private static final long serialVersionUID = -6424540398559729838L;
    private final SqlSession sqlSession;
    private final Class mapperInterface;
    private final Map<Method, MapperMethod> methodCache;

    public MybatisPlusPlusMapperProxy(SqlSession sqlSession, Class mapperInterface, Map<Method, MapperMethod> methodCache) {
            ...
            if(arg instanceof Collection){
                ...
                if(clazz != null){
                    if(StringUtils.isEmpty(pkFieldName)){
                        throw new MybatisPlusPlusRuntimeException("该实体类注解无主键！");
                    }
