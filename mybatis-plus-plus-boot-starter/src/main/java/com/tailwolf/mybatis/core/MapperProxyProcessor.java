...
import com.tailwolf.mybatis.core.proxy.MybatisPlusPlusMapperProxy;
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if(bean instanceof Proxy){
            ...
            if(invocationHandler instanceof MapperProxy){
                ...
                MybatisPlusPlusMapperProxy mybatisPlusPlusMapperProxy = new MybatisPlusPlusMapperProxy(sqlSession, mapperInterface, methodCache);
                return Proxy.newProxyInstance(mapperInterface.getClassLoader(), new Class[]{mapperInterface}, mybatisPlusPlusMapperProxy);
            }
