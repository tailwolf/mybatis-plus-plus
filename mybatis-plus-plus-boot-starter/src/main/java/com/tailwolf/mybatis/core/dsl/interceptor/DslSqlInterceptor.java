...
public class DslSqlInterceptor extends BaseInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if(dslWrapper instanceof EntityQuery){
            ...
            if (tableAnnot == null) {
                throw new MybatisPlusPlusRuntimeException("实体类必需加上注解@Table");
            }
        ...
        //双表查询
            ...
            if(fromObject == null  || joinObject == null){
                throw new MybatisPlusPlusRuntimeException("fromObject或joinObject不能为空");
            }
        ...
        //单表更新或删除
            ...
            if(entity == null){
                throw new MybatisPlusPlusRuntimeException("条件构造器的实体类参数不能为空！");
            }
            ...
            if(dslWrapper instanceof EntityUpdate){
                ...
                if(setNodeIterator.isEmpty()){
                    throw new MybatisPlusPlusRuntimeException("更新操作必须设置更新的属性！");
                }
